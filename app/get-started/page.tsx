  ...
  return (
    <StoreShell>
      <section className="shell section" style={{ maxWidth: 840 }}>
        <Link href="/brief" style={{ fontWeight: 700 }}>Kembali ke brief</Link>
        ...
        {!active ? (
          <section style={{ marginTop: 28, padding: 20, border: '1px solid var(--line)', borderRadius: 16, background: 'var(--blue-soft)' }}>
          ...
          <section style={{ marginTop: 28 }}>
            ...
            <ol style={{ listStyle: 'none', padding: 0, display: 'grid', gap: 12 }}>
              {steps.map((step, index) => {
                ...
                return (
                  <li key={step.title} style={{ display: 'grid', gridTemplateColumns: 'auto minmax(0,1fr)', gap: 14, padding: 18, border: '1px solid var(--line)', borderRadius: 14, background: complete ? '#f3faef' : '#fffdf9' }}>
